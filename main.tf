...
resource "aws_route_table_association" "tf_rt_sn_ass2" {
  subnet_id      = module.tf_pub_sn2.sn_id
  route_table_id = module.tf_pub_rt12.rt_id
}
...
#   subnet_id      = module.tf_pri_sn4.sn_id
#   route_table_id = module.tf_pri_rt34.rt_id
# }
...
# }
# resource "aws_route_table_association" "tf_rt_sn_ass6" {
#   subnet_id      = module.tf_db_sn6.sn_id
#   route_table_id = module.tf_db_rt56.rt_id
# }
...
#   vpc_id   = module.vpc.vpc_id
#   subnet_ids = [module.tf_pub_sn1.sn_id, module.tf_pub_sn2.sn_id]
# }
...
#   vpc_id   = module.vpc.vpc_id
#   subnet_ids = [module.tf_pri_sn3.sn_id, module.tf_pri_sn4.sn_id]
# }
...
#   pjt_name = "tf-db-nacl"
#   vpc_id   = module.vpc.vpc_id
#   subnet_ids = [module.tf_db_sn5.sn_id, module.tf_db_sn6.sn_id]
# }
